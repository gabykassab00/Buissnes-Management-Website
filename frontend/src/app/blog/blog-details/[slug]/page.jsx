...
<div className="overflow-x-hidden">
    ...
    <main className='content'>
      <Breadcrumb link="blog details" img={header} title="blog details" desc="the jobs report soundly beat expectations , with job gains broadly spread across the economy and about 60% higher "/>

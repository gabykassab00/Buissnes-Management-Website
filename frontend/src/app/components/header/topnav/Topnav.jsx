        ...
        <div className='right-block flex items-center gap-5'>
            <div className='line h-6 w-px bg-grey max-sm:hidden'></div>
                <div className='list-social flex items-center gap-2.5 max-sm:hidden'>
                    ...
                    <Link className='item rounded-full w-7 h-7 border-gray border-2 flex items-center justify-center' href="https://www.linkedin.com/" target='_blank'>
                    <i className='icon-in text-[10px]'></i>
                    </Link>

                    <Link className='item rounded-full w-7 h-7 border-gray border-2 flex items-center justify-center' href="https://www.twitter.com/" target='_blank'>
                    <i className='icon-twitter text-[10px]'></i>
                    </Link>

                    <Link className='item rounded-full w-7 h-7 border-gray border-2 flex items-center justify-center' href="https://www.youtube.com/" target='_blank'>
